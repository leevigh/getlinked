            ...
            <div className='max-w-[1500px] mx-auto py-16 flex justify-around items-start px-8'>
                ...
                <div className='hidden lg:block py-12'>
                    <div className='pb-[17px]'>
                        <h1 className='text-[32px] text-[#D434FE] font-semibold'>Get in touch</h1>
                    </div>
                    ...
                    <div className='pb-[21px]'>
                        <p className='max-w-[119px] text-white'>27, Alara Street Yaba 100012 Lagos State</p>
                    </div>
                    ...
                    <div className='pb-[35px]'>
                        <p className='text-white max-w-[272px]'>we are open from Monday-Friday 08:00am - 05:00pm</p>
                    </div>
                ...
                <div className='flex flex-col lg:flex-col w-full max-w-[617px] lg:bg-white lg:bg-opacity-[3%] lg:rounded-xl'>
                    <div className='block lg:hidden'>
                        <div className='flex justify-start py-[1.5rem]'>
                            <div className='w-[23px] h-[23px] grid place-items-center rounded-full border-gradient text-white' onClick={() => {}}>
                                <FiChevronLeft />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='max-w-[617px] lg:p-20'>
                        ...
                        <div className='pb-[30px]'>
                            <p className='text-white text-[12px] max-w-[239px]'>Email us below to any question related to our event</p>
                        </div>
