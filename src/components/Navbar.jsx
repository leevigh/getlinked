      ...
      <nav className="border-b-[0.1px] border-opacity-20 border-b-white lg:max-w-[1500px] mx-auto flex justify-between items-center lg:items-center pb-8 pt-10 px-8">
        ...
        <div className="hidden lg:flex lg:items-center">
          <div className="flex text-white font-normal">
            <Link to="/timeline">
              <div className="pr-14">Timeline</div>
            </Link>
            <Link to="/overview">
              <div className="pr-14">Overview</div>
            </Link>
            <Link to="/Faqs">
              <div className="pr-14">FAQs</div>
            </Link>
            <Link to="/contact-us">
              <div className="pr-14">Contact</div>
            </Link>
          </div>
        ...
        {isActive && (
          <div
            ...
            <div className="flex justify-end py-[1rem]">
              <div
                className="w-[23px] h-[23px] grid place-items-center rounded-full border-gradient"
                onClick={handleMenu}>
                <Close />
              </div>
            </div>
            <ul className="text-white">
              <Link to="/timeline">
                <li className="py-[1rem]">Timeline</li>
              </Link>
              <Link to="/overview">
                <li className="py-[1rem]">Overview</li>
              </Link>
              <Link to="/Faqs">
                <li className="py-[1rem]">FAQs</li>
              </Link>
              <Link to="/contact-us">
                <li className="py-[1rem]">Contact</li>
              </Link>

              <Link to={"/register"}>
                <div className="py-[1rem]">
                  <div className="px-12 py-4 w-fit rounded-sm register-btn">
                    Register
                  </div>
                </div>
              </Link>
