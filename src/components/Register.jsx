      ...
      <div className="px-8 py-8 max-w-[300px] mx-auto lg:flex lg:items-center lg:max-w-[1500px]">
        ...
        <div className="lg:bg-white lg:bg-opacity-[3%] lg:rounded-xl lg:p-10">
          <div className="hidden lg:block lg:pb-6">
            <h2 className="text-[#D434FE] text-[15px] lg:text-[32px] font-bold">
              Register
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col w-full">
            <div className="flex flex-col lg:flex-row lg:gap-8">
              <div className="flex flex-col pb-[18px]">
                <label className="text-[13px] text-white" htmlFor="">
                  Team&#39;s Name
                </label>
                <input
            ...
            <div className="flex pb-[18px] lg:gap-8">
              <div className="flex flex-col w-[70%] lg:w-full pr-[18px] lg:pr-0">
                ...
                <select
                  value={data.category}
                  onChange={handleChange}
                  className="p-2 rounded-[4px] bg-[#140D27] text-white border-[1px] border-white"
                  name="category"
                  id="">
            ...
            <div>
              <div className="text-[8.5px] lg:text-[12px] text-[#FF26B9]">
              ...
              <div className="flex items-start pt-3">
                ...
                <label
                  className="text-[10px] lg:text-[12px] text-white"
                  htmlFor="">
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative px-8 w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-[1px] border-[#D434FE] lg:p-8 rounded-[5px] shadow-lg relative flex flex-col w-full lg:min-w-[600px] bg-[#150E28ED] outline-none focus:outline-none">
                ...
                <div>
                  <p className="text-white text-[12px] lg:text-[14px] max-w-[220px] mx-auto text-center">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="py-[1rem] w-full px-8">
                    <div className="px-12 py-4 w-full rounded-sm text-white font-medium register-btn">
                      Back
                    </div>
                  </button>
                </div>
