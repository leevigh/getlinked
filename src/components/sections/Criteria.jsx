  ...
  return (
    <div className='bg-custom-bg-color border border-purple-400 border-l-0 border-r-0 p-4 py-8'>
        ...
        <div className=' flex flex-wrap lg:flex-nowrap justify-center items-center px-5 py-[40px] '>
            ...
            <div className=' text-center font-sans  px-11 lg:w-1/2 lg:text-left lg:ml-[3rem]  lg:mr-[2rem] lg:pr-[1.5rem]'>
                ...
                <p className='text-white text-[14px] p-4 lg:p-0 font-bold font-[montserrat] lg:pb-[16px]'>
