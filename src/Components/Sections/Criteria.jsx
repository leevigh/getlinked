...
const Criteria = () => {
  return (
    <div className='bg-custom-bg-color border border-purple-400 border-l-0 border-r-0 p-4 py-8'>


        <div className=' flex flex-wrap lg:flex-nowrap justify-center items-center px-5 py-[40px] lg:max-w-[1500px] mx-auto'>

            <div className='flex justify-center '>
                <img src={judge} alt="IMG" className=' h-200 w-200 items-center '/>
            </div>

            <div className='text-center lg:w-1/2 lg:text-left lg:ml-[3rem]  lg:mr-[2rem] lg:pr-[1.5rem]'>
                <p  className='text-xl lg:text-[32px] font-bold lg:pb-[32px]'>
                    <span className='text-white '>Judging Criteria</span><br/>
                    <span className='text-[#D434FE]'>Key Attributes</span>
                </p>

                <p className='text-white text-[14px] py-4 max-w-[300px] lg:max-w-[533px] lg:p-0 font-semibold font-[montserrat] lg:pb-[16px]'>
                ...
                <button className='bg-gradient-to-r from-[#FF26B9] via-[#FF26B9]-purple-200 to-purple-500 border rounded border-transparent px-3 py-1.5 font-extrabold text-white font-[montserrat] mt-4'>Read More</button>
